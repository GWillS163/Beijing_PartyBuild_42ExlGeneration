...
-- query item that requl != http://ke.youdao.com and client == web, order by ts desc
SELECT * FROM courselive WHERE requl != 'http://ke.youdao.com' AND client = 'web' ORDER BY ts DESC;
