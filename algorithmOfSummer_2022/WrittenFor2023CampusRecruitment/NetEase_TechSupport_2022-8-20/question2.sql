...
-- calculate the client count of client != Android from 2018-02-01 to 2018-02-05, and return nums
SELECT COUNT(*) FROM courselive WHERE client != 'Android' AND ts BETWEEN '2018-02-01' AND '2018-02-05';
