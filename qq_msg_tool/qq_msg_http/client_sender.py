...
class Interactive:
    ...
    # #     pass
    # #
    def send_group_pic_text(self,msg,from_group,anonymous):
        """
              	/**
               * 发送群图文消息
               * @param selfQQ
    ...
    def run(self):
        ...
        while True:
            try:
                input_text = '2/群聊消息/881621318'  # input('输入选择和内容, 用/ 分割:')
...
if __name__ == '__main__':
    # 本代码可以用来单独发送
    # 以下为示例代码 (作者自己用,可参考用法)
    s = Interactive("127.0.0.1", 8404, 430139105)    # 键入 初始配置: IP/ 端口/自己的QQ
    # s.run()
    s.private_msg('To 127', 532268865)
    # s.json_msg("233", 1274667113)
    # s.get_group_list('None')
    time.sleep(0.3)
    s.send_group_temporary_msg("你好啊", 881621318, 532268865)
