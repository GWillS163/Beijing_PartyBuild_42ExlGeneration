...
def make_qr_code(content, save_path=None, fill_color="black", back_color="white"):
    ...
    img = qr_code_maker.make_image(fill_color, back_color)
    if save_path:
        img.save(save_path)
    else:
        img.show()  # 中间图不显示
...
if __name__ == "__main__":
    ...
    make_qr_code_with_icon(
        code_Data, "qytanglogo.png", "qrcode.png")  # 内容，center图片，生成二维码图片
